...
<!-- End Google Tag Manager (noscript) -->";
        ...
        // Ihr Skript zum Aktualisieren des Consent Status basierend auf localStorage
        $updateConsentScript = "
<script>
    ...
    try {
      ...
      console.warn('Consent Mode konnte nicht gesetzt werden:', e);
        ...
        if ($body->length > 0) {
            ...
            // Das Update-Skript kann am Ende des Bodys oder nach GTM im Head eingefügt werden.
            // Da es 'DOMContentLoaded' verwendet, ist Ende Body eine sichere Wahl.
